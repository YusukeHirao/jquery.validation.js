...
(function() {
  ...
  (function(w, $) {
    ...
    var ALPHANUMERIC_CHARS_WITH_SIGN, ALPHA_CHARS, CustomRule, DEBUG_MODE, DIGIT_CAHRS, FULLWIDTH_ALPHANUMERIC_CHARS_WITH_SIGN, FULLWIDTH_ALPHA_CHARS, FULLWIDTH_DIGIT_CHARS, FULLWIDTH_SING_CHARS, HIRAGANA_CHARS, JAPANESE_SIGN_CHARS, KANA_COMMON_CAHRS, KATAKANA_CHARS, NARROW_JAPANESE_SIGN_CHARS, NARROW_KATAKANA_CHARS, Rule, RuleGroup, RuleMaster, SIGN_CHARS, SPACE_LIKE_CHARS, VString, Validation, checkGengo, log, showMessage, validateEnd, w2s, warn;
    DEBUG_MODE = true;
    SIGN_CHARS = '\\u0020-\\u002F\\u003A-\\u0041\\u005B-\\u0061\\u007B-\\u007E';
    DIGIT_CAHRS = '0-9';
    ALPHA_CHARS = 'A-Za-z';
    ...
    VString = (function(_super) {
      ...
      VString.prototype.isUnsignedInterger = function() {
        return this.isOnly(DIGIT_CAHRS);
      };
      ...
      Validation.customRules = {
        ...
        codeNum: new CustomRule({
          cast: function(value, args) {
            var digit, inAlpha, inHyphen;
            digit = parseInt(args[0], 10);
            inAlpha = args[1] === 'true' || args[1] === true;
            inHyphen = args[2] === 'true' || args[2] === true;
            return value.toCode(digit, inAlpha, inHyphen);
          },
          valid: function(value, args) {
            var digit, error, inAlpha, inHyphen, option;
            digit = parseInt(args[0], 10) || 1;
            inAlpha = args[1] === 'true' || args[1] === true;
            inHyphen = args[2] === 'true' || args[2] === true;
            option = DIGIT_CAHRS;
            error = ['半角数字'];
        ...
        date: new CustomRule({
          ...
          valid: function(values, options) {
            var $age, $elapsedMonth, $elapsedYear, $form, age, ageLimits, data, date, elapsedMonth, elapsedYear, fullYear, gengo, isAgeCheck, month, rangeError, thedate, today, year, _ref, _ref1, _ref2, _ref3;
            ...
            isAgeCheck = !!(options != null ? options.age : void 0);
            ageLimits = isAgeCheck ? options.age[0] : Infinity;
            $age = $(this.age);
    ...
    RuleMaster = (function() {
      ...
      function RuleMaster($form, rules, onShowMessage, onValidateEnd) {
        ...
        log($elem);
        this.form = $form[0];
        this.onShowMessage = onShowMessage || showMessage;
        this.onValidateEnd = onValidateEnd || validateEnd;
      }
    ...
    RuleGroup = (function() {
      ...
      RuleGroup.prototype.check = function() {
        ...
        if (this.requireRule != null) {
          ...
          castedValues = customRule.cast(elems, values, this.requireRule.params, this.master);
          errorMessage = customRule.valid(elems, castedValues, this.requireRule.params, this.master);
          if (errorMessage) {
            return errorMessage;
          }
        }
    ...
    Rule = (function() {
      ...
      Rule.prototype.check = function() {
        var castedValue, elem, errorMessage, method, rule, value, _i, _len, _ref;
        value = this.getValue();
        castedValue = value;
        elem = this.$elem[0];
        if (this.requireRule != null) {
          method = Validation.customRules[this.requireRule.name];
          castedValue = method.cast(elem, castedValue, this.requireRule.params, this.master);
          errorMessage = method.valid(elem, castedValue, this.requireRule.params, this.master);
          if (errorMessage) {
            return errorMessage;
          }
        }
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (method) {
            ...
            castedValue = method.cast(elem, castedValue, rule.params, this.master);
            errorMessage = method.valid(elem, castedValue, rule.params, this.master);
            if (errorMessage) {
              return errorMessage;
            }
          }
    ...
    $.fn.validation = function(rulesOrMethod, customRules, onShowMessage, onValidateEnd) {
      ...
      if (rules) {
        ...
        rules = new RuleMaster(this, rulesOrMethod, onShowMessage, onValidateEnd);
        ...
        $elem.on('blur change', 'input, select, textarea', function() {
    ...
    showMessage = function(passed, message) {
    ...
    validateEnd = function(passed, messages, messagesArray) {
      var top;
      if (!passed) {
